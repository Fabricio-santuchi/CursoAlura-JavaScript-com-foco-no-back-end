...
const encontrarNumero = numeros.find(elemento => elemento === numeroProcurado);
if(encontrarNumero){
...
//findIndex
const encontrarIndice = numeros.findIndex(elemento => elemento === numeroProcurado);
if(encontrarIndice !== -1){
    console.log(`O Indice desse número é ${encontrarIndice}!`);
}else{
    console.log(`O Indice desse número é ${encontrarIndice}! Atenção se o valor for -1 ELE NÃO ESTÁ NA LISTA!`);
}
